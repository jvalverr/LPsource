...
#ifndef WEIGHTEDADAMICADARLP_H_INCLUDED
#define WEIGHTEDADAMICADARLP_H_INCLUDED
...
class WeightedAdamicAdarLP : public LinkPredictor {
    private:
	protected:
	public:
		WeightedAdamicAdarLP( const Network& );
		~WeightedAdamicAdarLP();
