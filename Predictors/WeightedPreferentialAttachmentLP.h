...
#ifndef WEIGHTEDPREFERENTIALATTACHMENTLP_H_INCLUDED
#define WEIGHTEDPREFERENTIALATTACHMENTLP_H_INCLUDED


#include "../Network.h"
#include "LinkPredictor.h"

class WeightedPreferentialAttachmentLP : public LinkPredictor {
	private:
	protected:
	public:
		WeightedPreferentialAttachmentLP( const Network& );
		~WeightedPreferentialAttachmentLP();
...
#endif // WEIGHTEDPREFERENTIALATTACHMENTLP_H_INCLUDED
