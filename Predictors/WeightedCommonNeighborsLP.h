...
#ifndef WEIGHTEDCOMMONNEIGHBORSLP_H_INCLUDED
#define WEIGHTEDCOMMONNEIGHBORSLP_H_INCLUDED
...
class WeightedCommonNeighborsLP : public LinkPredictor {
    private:
	protected:
	public:
		WeightedCommonNeighborsLP( const Network& );
		~WeightedCommonNeighborsLP();
		double generateScore( index_v, index_v );
};

#endif // WEIGHTEDCOMMONNEIGHBORSLP_H_INCLUDED
