...
#ifndef COMMONNEIGHBORSOFGROUPSLP_H_INCLUDED
#define COMMONNEIGHBORSOFGROUPSLP_H_INCLUDED
...
class CommonNeighborsOfGroupsLP : public LinkPredictor {
	private:
	protected:
	public:
		CommonNeighborsOfGroupsLP( const Network& );
		~CommonNeighborsOfGroupsLP();
		double generateScore( index_v, index_v );
};

#endif // COMMONNEIGHBORSOFGROUPSLP_H_INCLUDED
