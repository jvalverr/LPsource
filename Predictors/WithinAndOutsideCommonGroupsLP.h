...
#ifndef WITHINANDOUTSIDECOMMONGROUPSLP_H_INCLUDED
#define WITHINANDOUTSIDECOMMONGROUPSLP_H_INCLUDED


#include "../Network.h"
#include "LinkPredictor.h"

class WithinAndOutsideCommonGroupsLP : public LinkPredictor {
	private:
	protected:
	public:
		WithinAndOutsideCommonGroupsLP( const Network& );
		~WithinAndOutsideCommonGroupsLP();
		double generateScore( index_v, index_v );
};

#endif // WITHINANDOUTSIDECOMMONGROUPSLP_H_INCLUDED
