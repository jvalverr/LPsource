...
#ifndef PREFERENTIALATTACHMENTLP_H_INCLUDED
#define PREFERENTIALATTACHMENTLP_H_INCLUDED


#include "../Network.h"
#include "LinkPredictor.h"

class PreferentialAttachmentLP : public LinkPredictor {
	private:
	protected:
	public:
		PreferentialAttachmentLP( const Network& );
		~PreferentialAttachmentLP();
		double generateScore( index_v, index_v );

};


#endif // PREFERENTIALATTACHMENTLP_H_INCLUDED
