...
#ifndef RESOURCEALLOCATIONLP_H_INCLUDED
#define RESOURCEALLOCATIONLP_H_INCLUDED


#include "../Network.h"
#include "LinkPredictor.h"

class ResourceAllocationLP : public LinkPredictor {
	private:
	protected:
	public:
		ResourceAllocationLP( const Network& );
		~ResourceAllocationLP();
		double generateScore( index_v, index_v );
};

#endif // RESOURCEALLOCATIONLP_H_INCLUDED
