...
#ifndef COMMONNEIGHBORSLP_H_INCLUDED
#define COMMONNEIGHBORSLP_H_INCLUDED
...
class CommonNeighborsLP : public LinkPredictor {
	private:
	protected:
	public:
		CommonNeighborsLP( const Network& );
		~CommonNeighborsLP();
		double generateScore( index_v, index_v );
};


#endif // COMMONNEIGHBORSLP_H_INCLUDED
