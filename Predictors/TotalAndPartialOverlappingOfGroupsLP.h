...
#ifndef TOTALANDPARTIALOVERLAPPINGOFGROUPSLP_H_INCLUDED
#define TOTALANDPARTIALOVERLAPPINGOFGROUPSLP_H_INCLUDED
...
class TotalAndPartialOverlappingOfGroupsLP : public LinkPredictor {
	private:
	protected:
	public:
		TotalAndPartialOverlappingOfGroupsLP( const Network& );
		~TotalAndPartialOverlappingOfGroupsLP();
		double generateScore( index_v, index_v );
};

#endif // TOTALANDPARTIALOVERLAPPINGOFGROUPSLP_H_INCLUDED
